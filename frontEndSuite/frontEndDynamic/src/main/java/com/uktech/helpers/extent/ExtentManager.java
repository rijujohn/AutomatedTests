...
package com.uktech.helpers.extent;
import java.io.File;
...
import com.relevantcodes.extentreports.ExtentReports;
	...
	public class ExtentManager {
		...
		public static String reportPath = System.getProperty("user.dir") + "//build//test-results//frontEndDynamic//Report.html";
		...
		public static ExtentReports  getInstances(){
			...
			if (extent == null){
				...
				extent.loadConfig(new File(System.getProperty("user.dir")+"//src//main//java//com//uktech//helpers//extent//extent-config.xml"));
